      ...
      Gambar
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
				...
				<img class="d-block w-100" src="MBS 1.png" alt="First slide">
            </div>
                      </div>
          <a class="carousel-control-prev" href="MBS 2.png" role="button" data-slide="prev">
            <span class="carousel-control-custom-icon" aria-hidden="true">
              <i class="fas fa-chevron-left"></i>
            </span>
            <span class="sr-only">Previous</span>
          </a>
          <a class="carousel-control-next" href="MBS 3.png" role="button" data-slide="next">
            <span class="carousel-control-custom-icon" aria-hidden="true">
        ...
        <table class="table table-bordered">
          <thead>
			 <tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td>Komplek Ruko Loka Indah Blok B No.28-29 RT.005 RW.02 Jl. Mangga Besar IX, Kelurahan Tangki, Kecamatan Tamansari, Kota Jakarta Barat, Provinsi DKI Jakarta.</tr>
			 <tr>
              <td>Basis Nilai</td>
              <td>: </td>
			...
			<tr>
              ...
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B008'43.4%22S+106%C2%B049'22.4%22E/@-6.1471114,106.8190785,16z/data=!4m4!3m3!8m2!3d-6.145394!4d106.822898?entry=ttu">
         -6.145394, 106.822898 											
                  </a></td>
            </tr>
			<tr>
